...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for member in root.findall('object'):
            ...
            # if member.find('name') not in self.classes:
            #     continue
            ...
            if xmax_final<=xmin_final:
                xmax_final = xmin_final+0.01
            if yamx_final<=ymin_final:
                yamx_final = ymin_final+0.01
        ...
        if self.transforms:
            ...
            # print(f"Target box shape: {target['boxes'].shape}")
